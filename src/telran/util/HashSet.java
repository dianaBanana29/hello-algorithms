...
private class HashSetIterator implements Iterator<T>{
	...
	public boolean add(T obj) {
		//set can`t have two equal objects
		//thats why the method returns false at adding an
	...
	HashSet<T> tmp = new HashSet<>(hashTable.length * 2);//tmp hashset has table with twice bigger size
